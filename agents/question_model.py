...
class QAgent(object):
    def __init__(self, **kwargs):
        model_name = "logical_reasoning_rocm_merged_final"
...
if __name__ == "__main__":
    ...
    model = QAgent()
    prompt = f"""
    Question: Generate a hard MCQ based question as well as their 4 choices and its answers on the topic  Seating arrangement (circular and linear), family tree and blood relations. Return your response as a valid JSON object with this exact structure:
