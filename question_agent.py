...
class QuestioningAgent(object):
    ...
    def build_prompt(
        ...
        if wadvsys:
            sys_prompt = """
            You are an **expert-level examiner** with deep expertise in designing **highly challenging and conceptually rigorous multiple-choice questions (MCQs)** for the **Quantitative Aptitude and Analytical Reasoning** sections of top-tier competitive exams. Each question is unique and should not be repeated.
        ...
        tmpl = (
            ...
            "{5}"
            "RESPONSE FORMAT:\n"
            "Return **only** a valid JSON object, without any text, commentary, or preamble. Do not add markdown, introductions, or explanations.\n\n"
            "EXACT FORMAT:\n"
            "{{\n"
            '  "topic": "{7}",\n'
            '  "question": "...",\n'
